...
export default class AndroidNotifications {
	...
	createChannel(channel) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.createChannel(channel.build());
		}
	...
	createChannelGroup(channelGroup) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.createChannelGroup(channelGroup.build());
		}
	...
	createChannelGroups(channelGroups) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.createChannelGroups(nativeChannelGroups);
		}
	...
	createChannels(channels) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.createChannels(nativeChannels);
		}
	...
	removeDeliveredNotificationsByTag(tag) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.removeDeliveredNotificationsByTag(tag);
		}
	...
	deleteChannelGroup(groupId) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.deleteChannelGroup(groupId);
		}
	...
	deleteChannel(channelId) {
		if (Platform.OS === "android") {
			...
			return RnLocalScheduleNotifications.deleteChannel(channelId);
		}
	...
	getChannel(channelId) {
		if (Platform.OS === "android") {
			...
			return Promise.resolve(RnLocalScheduleNotifications.getChannel(channelId));
		}
	...
	getChannels() {
		if (Platform.OS === "android") {
			return Promise.resolve(RnLocalScheduleNotifications.getChannels());
		}
	...
	getChannelGroup(channelGroupId) {
		if (Platform.OS === "android") {
			...
			return Promise.resolve(RnLocalScheduleNotifications.getChannelGroup(channelGroupId));
		}
	...
	getChannelGroups() {
		if (Platform.OS === "android") {
			return Promise.resolve(RnLocalScheduleNotifications.getChannelGroups());
		}
