 ...
 */
public class RnLocalScheduleNotificationsRebootReceiver extends BroadcastReceiver {
  @Override
  public void onReceive(Context context, Intent intent) {
    Log.i("RNFNotifRebootReceiver", "Received reboot event");
    new RnLocalScheduleNotificationManager(context).rescheduleNotifications();
  }
}
