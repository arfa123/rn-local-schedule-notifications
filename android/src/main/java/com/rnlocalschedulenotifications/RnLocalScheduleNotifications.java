...
import com.rnlocalschedulenotifications.Utils;
import me.leolin.shortcutbadger.ShortcutBadger;

import static com.rnlocalschedulenotifications.Utils.getResId;

public class RnLocalScheduleNotifications extends ReactContextBaseJavaModule implements ActivityEventListener {
  private static final String BADGE_FILE = "BadgeCountFile";
  private static final String BADGE_KEY = "BadgeCount";
  private static final String TAG = "RnLocalScheduleNotifications";

  private SharedPreferences sharedPreferences = null;

  private RnLocalScheduleNotificationManager notificationManager;

  RnLocalScheduleNotifications(ReactApplicationContext context) {
    super(context);
    context.addActivityEventListener(this);

    notificationManager = new RnLocalScheduleNotificationManager(context);
    ...
    localBroadcastManager.registerReceiver(
      ...
      new IntentFilter(RnLocalScheduleNotificationManager.SCHEDULED_NOTIFICATION_EVENT)
    );
  }

  @Override
  public String getName() {
    return "RnLocalScheduleNotifications";
  }
